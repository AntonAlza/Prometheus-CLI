...
@Component({
  selector: 'app-tablero-limites',
  templateUrl: './tablero-limites.component.html',
  styleUrls: ['./tablero-limites.component.scss']
})
export class TableroLimitesComponent implements OnInit {
  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='b9d973fc-4f0e-4192-a769-820f4c0c38c9'; 
