...
@Component({
  selector: 'app-variacion-mtm',
  templateUrl: './variacion-mtm.component.html',
  styleUrls: ['./variacion-mtm.component.scss']
})
export class VariacionMTMComponent implements OnInit {

public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='583f8ca3-9cfc-44d9-9c70-d32404b27ca3'; 
