...
@Component({
  selector: 'app-powerbipapeles',
  templateUrl: './powerbipapeles.component.html',
  styleUrls: ['./powerbipapeles.component.scss']
})
export class PowerbipapelesComponent implements OnInit {

public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='335da9dc-1f16-470f-b7c1-957f49ad2243'; 
