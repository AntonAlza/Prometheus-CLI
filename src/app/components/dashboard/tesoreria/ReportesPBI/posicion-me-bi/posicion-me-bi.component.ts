...
@Component({
  selector: 'app-posicion-me-bi',
  templateUrl: './posicion-me-bi.component.html',
  styleUrls: ['./posicion-me-bi.component.scss']
})
export class PosicionMEBIComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='f755c5a1-71ee-4799-88da-9cdfbf4b3fa1'; 
