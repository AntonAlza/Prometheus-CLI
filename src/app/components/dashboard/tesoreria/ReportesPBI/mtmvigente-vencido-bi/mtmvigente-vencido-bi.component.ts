...
@Component({
  selector: 'app-mtmvigente-vencido-bi',
  templateUrl: './mtmvigente-vencido-bi.component.html',
  styleUrls: ['./mtmvigente-vencido-bi.component.scss']
})
export class MTMVigenteVencidoBIComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='8185c014-e660-4299-bd52-7267b570ecc3'; 
