...
@Component({
  selector: 'app-operacionesifd-bi',
  templateUrl: './operacionesifd-bi.component.html',
  styleUrls: ['./operacionesifd-bi.component.scss']
})
export class OPERACIONESIFDBIComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='7aab1c00-c8eb-479b-9be6-a94774337355'; 
