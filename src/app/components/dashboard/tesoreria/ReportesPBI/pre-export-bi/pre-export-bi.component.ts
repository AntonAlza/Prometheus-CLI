...
@Component({
  selector: 'app-pre-export-bi',
  templateUrl: './pre-export-bi.component.html',
  styleUrls: ['./pre-export-bi.component.scss']
})
export class PreExportBIComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='c7e0d880-95d7-4b91-9a3f-b4ec33b00ebc'; 
