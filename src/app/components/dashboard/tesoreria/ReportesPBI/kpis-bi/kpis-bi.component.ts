...
@Component({
  selector: 'app-kpis-bi',
  templateUrl: './kpis-bi.component.html',
  styleUrls: ['./kpis-bi.component.scss']
})
export class KPISBIComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='40dfd550-0a44-4df1-85e7-3a6012dcbfc8'; 
