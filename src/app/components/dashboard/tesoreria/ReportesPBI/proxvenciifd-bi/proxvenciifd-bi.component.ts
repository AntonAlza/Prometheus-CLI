...
@Component({
  selector: 'app-proxvenciifd-bi',
  templateUrl: './proxvenciifd-bi.component.html',
  styleUrls: ['./proxvenciifd-bi.component.scss']
})
export class PROXVENCIIFDBIComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='675113e1-3fcc-47b0-9546-eb4e8851eaf5'; 
