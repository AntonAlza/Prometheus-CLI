...
@Component({
  selector: 'app-resumenteso',
  templateUrl: './resumenteso.component.html',
  styleUrls: ['./resumenteso.component.scss']
})
export class ResumentesoComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='2f5cae13-eafe-4aa4-aa99-faddc256bb9d'; 
