...
@Component({
  selector: 'app-caja-bi',
  templateUrl: './caja-bi.component.html',
  styleUrls: ['./caja-bi.component.scss']
})
export class CAJABIComponent implements OnInit {

  public tokenBearer:string;
  public tokenreport:string
  public  embedUrl: string;
  public groupId: string='6a717c82-ca85-44c2-b5c4-a5dd1235b56b';
  public reportId: string='59735e70-1ef5-4d1b-a972-205eb3db6797'; 
